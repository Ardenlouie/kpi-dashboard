...
use App\Http\Controllers\{
    ...
    NotificationController, PositionController, OrgStructureController, BeviController, NewProductController
};
...
Route::group(['middleware' => ['auth', 'optimizeImages']], function() {
    ...
    Route::get('/account-data/{month}/{year}/{company}', [App\Http\Controllers\HomeController::class, 'accountData'])->name('accountData');
    ...
    Route::group(['middleware' => 'permission:user access'], function() {
        ...
        Route::get('bevi', [BeviController::class, 'index'])->name('bevi.index');
    ...
    Route::group(['middleware' => 'permission:user access'], function() {
        ...
        Route::get('newproduct', [NewProductController::class, 'index'])->name('newproduct.index');
        Route::get('/new-fetch', [NewProductController::class, 'fetchData'])->name('newProduct');
        Route::get('/daily-data/{month}/{year}', [NewProductController::class, 'dailyData']);
